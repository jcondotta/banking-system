...
class InternalTransferRequestedEventRoutingResolverTest {
    ...
    private final InternalTransferRequestedEventRoutingResolver resolver =
        new InternalTransferRequestedEventRoutingResolver(TOPICS_PROPERTIES);

    @Test
    void shouldCreateRouting_whenInternalTransferRequestedEvent() {
        ...
        assertThat(resolver.domainEventType()).isEqualTo(InternalTransferRequestedEvent.class);
        assertThat(routing.destination()).isEqualTo("custom-internal-transfer-requested");
