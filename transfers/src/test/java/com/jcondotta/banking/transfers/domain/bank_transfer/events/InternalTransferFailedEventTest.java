...
class InternalTransferFailedEventTest {
    ...
    void shouldCreateEvent_whenAllParamsAreValid() {
        var event = new InternalTransferFailedEvent(EVENT_ID, BANK_TRANSFER_ID, OCCURRED_AT);
    ...
    void shouldThrowException_whenEventIdIsNull() {
        assertThatThrownBy(() -> new InternalTransferFailedEvent(null, BANK_TRANSFER_ID, OCCURRED_AT))
    ...
    void shouldThrowException_whenAggregateIdIsNull() {
        assertThatThrownBy(() -> new InternalTransferFailedEvent(EVENT_ID, null, OCCURRED_AT))
            .isInstanceOf(DomainValidationException.class)
    ...
    void shouldThrowException_whenOccurredAtIsNull() {
        assertThatThrownBy(() -> new InternalTransferFailedEvent(EVENT_ID, BANK_TRANSFER_ID, null))
            .isInstanceOf(DomainValidationException.class)
