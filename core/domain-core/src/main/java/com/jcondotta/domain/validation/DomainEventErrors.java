...
public final class DomainEventErrors {
  ...
  public static final String EVENT_DATA_MUST_BE_PROVIDED = "event data must be provided";
  public static final String EVENT_METADATA_MUST_BE_PROVIDED = "event metadata must be provided";
