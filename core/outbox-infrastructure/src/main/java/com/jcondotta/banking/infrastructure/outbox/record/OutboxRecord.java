...
public interface OutboxRecord {
  ...
  /**
   * The routing/partition key captured from {@code EventPublication.routing()} at write time.
   ...
   * Populated from {@code EventPublication.routing()} at write time,
   * ensuring the routing decision is honoured at publish time.
   */
