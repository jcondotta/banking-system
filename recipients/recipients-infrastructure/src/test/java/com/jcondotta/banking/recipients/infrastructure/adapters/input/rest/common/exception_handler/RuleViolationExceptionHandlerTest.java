...
class RuleViolationExceptionHandlerTest {
  ...
  private static final String REQUEST_URI = "/api/recipients/recipient-id";
  private static final String EXCEPTION_MESSAGE = "Recipient does not belong to bank account";
