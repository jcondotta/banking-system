...
class OutboxStatusQueryKeyTest {
  ...
  @Test
  void shouldBuildSortKey_whenStatusIsProcessing() {
    assertThat(OutboxStatusQueryKey.buildSortKey(OutboxStatus.PROCESSING))
      .isEqualTo(OutboxStatusQueryKey.SORT_KEY_PROCESSING_PREFIX);
  }
