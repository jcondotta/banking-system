...
import com.jcondotta.banking.accounts.infrastructure.adapters.input.rest.common.filter.CorrelationFilter;
...
public class MethodArgumentNotValidExceptionHandler {
  ...
  public ResponseEntity<ProblemDetail> handleValidationException(
    ...
    var logEvent = log.atWarn()
      ...
      .addKeyValue("event_type", "accounts.operation.failed")
