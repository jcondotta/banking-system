...
class BankAccountClosedIntegrationPayloadTest {
  ...
  void shouldCreatePayload_whenAllFieldsAreValid() {
    var payload = new BankAccountClosedIntegrationPayload(BANK_ACCOUNT_ID);
  ...
  void shouldDeserializePayload_whenJsonIsValid() throws Exception {
    ...
    var deserialized = OBJECT_MAPPER.readValue(json, BankAccountClosedIntegrationPayload.class);
