...
class BankAccountBlockedIntegrationPayloadTest {
  ...
  void shouldCreatePayload_whenAllFieldsAreValid() {
    var payload = new BankAccountBlockedIntegrationPayload(BANK_ACCOUNT_ID);
  ...
  void shouldDeserializePayload_whenJsonIsValid() throws Exception {
    ...
    var deserialized = OBJECT_MAPPER.readValue(json, BankAccountBlockedIntegrationPayload.class);
