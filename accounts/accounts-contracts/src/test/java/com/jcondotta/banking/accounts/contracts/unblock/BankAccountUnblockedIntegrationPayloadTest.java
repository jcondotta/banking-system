...
class BankAccountUnblockedIntegrationPayloadTest {
  ...
  void shouldCreatePayload_whenAllFieldsAreValid() {
    var payload = new BankAccountUnblockedIntegrationPayload(BANK_ACCOUNT_ID);
  ...
  void shouldDeserializePayload_whenJsonIsValid() throws Exception {
    ...
    var deserialized = OBJECT_MAPPER.readValue(json, BankAccountUnblockedIntegrationPayload.class);
