...
import com.jcondotta.banking.ledger.domain.ledger_account.value_objects.AccountBalance;
import com.jcondotta.banking.ledger.domain.ledger_account.value_objects.AccountReference;
import com.jcondotta.banking.ledger.domain.ledger_account.value_objects.Balance;
import com.jcondotta.banking.ledger.infrastructure.adapters.output.persistence.entity.AccountBalanceEntity;
...
public class LedgerAccountEntityMapper {
    ...
    public LedgerAccount toDomain(LedgerAccountEntity entity, AccountBalanceEntity balanceEntity) {
        ...
        return LedgerAccount.restore(
                ...
                entity.getCreatedAt(),
                new AccountBalance(
                    Balance.of(balanceEntity.getBookedAmount(), currency),
                    Balance.of(balanceEntity.getHeldAmount(), currency)
                )
        );
    }
}
